...
function calculerMoyenneModule6() {
  ...
  var noteModuletp6 = parseFloat(document.getElementById("TP6").value);
  var resultatElement = document.getElementById("moyenneModule6");

  if (noteModulecc6 < 0 || noteModulecc6 > 20 || noteModuleef6 < 0 || noteModuleef6 > 20 || noteModuletp6 < 0 || noteModuletp6 > 20) {
    resultatElement.innerHTML = "Les valeurs saisies sont incorrectes";
    resultatElement.classList.remove("text-red");
    resultatElement.classList.remove("text-green");
  } else {
    var moyenneModule6 = (noteModuletp6 * 0.20) + (noteModulecc6 * 0.20) + (noteModuleef6 * 0.60);
...
function calculerMoyenneModule8() {
  var noteModuleef8 = parseFloat(document.getElementById("EF8").value);
  var resultatElement = document.getElementById("moyenneModule8");

  if (noteModuleef8 < 0 || noteModuleef8 > 20) {
    resultatElement.innerHTML = "Les valeurs saisies sont incorrectes";
    resultatElement.classList.remove("text-red");
    resultatElement.classList.remove("text-green");
  } else {
    var moyenneModule8 = noteModuleef8;
    resultatElement.innerHTML = "" + moyenneModule8.toFixed(2);

    if (moyenneModule8 >= 10) {
      resultatElement.classList.remove("text-red");
      resultatElement.classList.add("text-green");
    } else {
      resultatElement.classList.remove("text-green");
...
function calculerMoyenneGenerale() {
  ...
  var moyenneModule8 = parseFloat(document.getElementById("moyenneModule8").innerHTML);

  var moyenneGenerale = ((moyenneModule1*4)+(moyenneModule2*2)+(moyenneModule3*2)+(moyenneModule4*2)+(moyenneModule5*2)+(moyenneModule6*4)+(moyenneModule7)+(moyenneModule8)) / 18;
